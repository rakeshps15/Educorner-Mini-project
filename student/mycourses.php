<?php
require('header.php');
$sql="select * from educorner_learner_course c, educorner_faculty_course f,educorner_payment p where f.course_id=c.course_id and c.course_enrollid=p.course_enrollid and f.startdate>'$d' and c.email='$email'";
// echo $sql;
