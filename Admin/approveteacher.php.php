          ...
          <div class="card-body">
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                if (isset($_GET['id'])) {
                  $email = $_GET['id'];
                  $sql = "update educorner_login set status=0 where username='$email'";
                ...
                ?>
                    <script>
                      Swal.fire({
                        ...
                        text: 'Updated',
                        didClose: () => {
                          window.location.replace('../Admin/../approveteacher.php.php');
                        }
                      });
                    </script>
                ...
                $res = select("select *from educorner_registration WHERE email in(SELECT username from educorner_login WHERE status=0 and user_type=2)");
