                ...
                ?>
                  <tr>
                    <th scope="row"><?php echo $n?> </th>
                     ...
                     <td class="btn-group"><a class="btn btn-success btn-sm " href="approveteacher.php.php?id=<?php echo $id;?>">Approve</a><a class="btn btn-danger btn-sm"href="pendingrequest.php?id=<?php echo $id;?>">Reject</a></td>
                  </tr>   
                    <!-- <td>Designer</td>
                    <td>28</td>
                    <td>2016-05-25</td> -->
