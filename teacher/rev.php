<?php
require('header.php');
$sql="select * from educorner_rerview c,educorner_registration r where c.learner_email=r.email";
...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Student Review</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
              ...
              while($row=mysqli_fetch_assoc($a))
              {
                ...
                ?>
                 <tr>
                  ...
                  <td><?php echo $row['date_review'];?></td>
